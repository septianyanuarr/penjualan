<form action="<?php echo base_url(); ?>pelanggan/updatepelanggan" class="formpelanggan" method="POST">
    <div class="form-group mb-3">
        <input type="text" value="<?php echo $pelanggan['kode_pelanggan']; ?>" class="form-control" name="kodepelanggan" placeholder="Kode Pelanggan">
    </div>
    <div class="form-group mb-3">
    ...
    <div class="form-group mb-3">
        <select name="dropshipper" class="form-select">
            ...
            <?php foreach ($dropshipper as $d) { ?>
                <option <?php if ($pelanggan['kode_dropshipper'] == $d->kode_dropshipper) {
                            echo "selected";
                        } ?> value="<?php echo $d->kode_dropshipper; ?>"><?php echo $d->kode_dropshipper ?></option>
            <?php } ?>
        </select>
    </div>
    <div class="mb-3">
